...
## 待辦 Backlog(依優先序)
1. **策展選圖(14 件未完成)**:MAXXI、薩拉戈薩橋亭、謝赫扎耶德大橋、格拉斯哥河畔博物館、倫敦水上運動中心、銀河 SOHO、香港理大創新樓、安特衛普港務局、薩萊諾客運站、520 West 28th、KAPSARC、麗澤 SOHO、千博物館、長沙梅溪湖。
   - 標準:Wikimedia Commons 自由授權、外觀代表角度、寬度 ≥2000px、避開 interior/construction/detail
   - 已完成 10 件範例見 WORKS 內現有 `img:` 欄位
